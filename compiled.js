...
var _user$project$Main$somePageView = F2(
	function (str, model) {
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: _elm_lang$html$Html$text(
					A2(_elm_lang$core$Basics_ops['++'], 'Page: ', str)),
				_1: {
					ctor: '::',
					_0: A2(
		...
		return A2(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Lazy bug'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: function () {
						...
						switch (_p1.ctor) {
									...
									{ctor: '[]'},
									{
										...
										_1: {
											...
											_0: A2(
												...
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$href('#/page/some'),
													_1: {ctor: '[]'}
												},
												{
													ctor: '::',
													_0: _elm_lang$html$Html$text('Some Page'),
													_1: {ctor: '[]'}
												}),
											_1: {ctor: '[]'}
										}
							...
							case 'SomePage':
								return A2(_user$project$Main$somePageView, _p1._0, model);
							default:
								return A2(
									_elm_lang$html$Html$div,
									{ctor: '[]'},
...
var _user$project$Main$Model = F2(
	function (a, b) {
		return {loaded: a, route: b};
	});
var _user$project$Main$NotFoundRoute = {ctor: 'NotFoundRoute'};
var _user$project$Main$SomePage = function (a) {
	return {ctor: 'SomePage', _0: a};
};
var _user$project$Main$Index = {ctor: 'Index'};
var _user$project$Main$matchers = _evancz$url_parser$UrlParser$oneOf(
	{
		ctor: '::',
		_0: A2(_evancz$url_parser$UrlParser$map, _user$project$Main$Index, _evancz$url_parser$UrlParser$top),
		_1: {
			ctor: '::',
			_0: A2(
				_evancz$url_parser$UrlParser$map,
				_user$project$Main$SomePage,
				A2(
...
var _user$project$Main$parseLocation = function (location) {
	return A2(
		...
		A2(_evancz$url_parser$UrlParser$parseHash, _user$project$Main$matchers, location));
};
var _user$project$Main$init = function (location) {
	var currentRoute = _user$project$Main$parseLocation(location);
	var model = A2(_user$project$Main$Model, false, currentRoute);
	return A2(
		_elm_lang$core$Platform_Cmd_ops['!'],
		model,
		{ctor: '[]'});
...
var _user$project$Main$subscriptions = function (model) {
	return A2(_elm_lang$core$Time$every, 3 * _elm_lang$core$Time$second, _user$project$Main$GetData);
};
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Main.Msg":{"args":[],"tags":{"OnLocationChange":["Navigation.Location"],"GetData":["Time.Time"],"NoOp":[]}}},"aliases":{"Time.Time":{"args":[],"type":"Float"},"Navigation.Location":{"args":[],"type":"{ href : String , host : String , hostname : String , protocol : String , origin : String , port_ : String , pathname : String , search : String , hash : String , username : String , password : String }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
